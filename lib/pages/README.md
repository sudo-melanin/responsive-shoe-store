...
* **/core/const:** Centralized storage for mock data and application-wide constants, ensuring the root directory remains strictly for application initialization.
